...
Access the class workspace [here](https://gsueconsp2021.slack.com), or click on the [<i class="fab fa-slack"></i>](https://gsueconsp2021.slack.com) icon in the header of this page. If you're unfamiliar with Slack, [scroll through Slack's official demo here](https://slackdemo.com/).
